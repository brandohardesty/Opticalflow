...
def opticalFlow(img,img2):
    ...
    visualization = np.zeros((image.shape[0],image.shape[1],3),np.float32)
    visualizationx = np.zeros((image.shape[0], image.shape[1], 3), np.float32)
    visualizationy = np.zeros((image.shape[0], image.shape[1], 3), np.float32)
